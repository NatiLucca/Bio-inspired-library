...
for i in $(seq 1 30);
do
	./pso $pop -600 600 $c1 $c2 5000 griewank $inertia 50 $typeF $i 1 >> Resultados/GriewankS.csv
done
...
# ## BENCHMARK Alpine##
# for i in $(seq 1 30); # GERA ARQUIVOS DE INPUT #
# do
# 	./pso $pop 0 10 $c1 $c2 3000 alpine $inertia 10 $typeF $i 0 >> temp.csv
# done
#
# for i in $(seq 1 30); # PSO Sequencial #
# do
# 	./pso $pop 0 10 $c1 $c2 3000 alpine $inertia 10 $typeF $i 1 >> Resultados/AlpineS.csv
# done
#
# for i in $(seq 1 30); # PSO Paralelo #
# do
...
# for i in $(seq 1 30);
# do
# 	./pso $pop -10 10 $c1 $c2 1000 booth $inertia 2 $typeF $i 1 >> Resultados/BoothS.csv
# done
#
# for i in $(seq 1 30);
# do
...
# for i in $(seq 1 30);
# do
# 	./pso $pop -100 100 $c1 $c2 1000 easom $inertia 2 $typeF $i 1 >> Resultados/EasomS.csv
# done
#
# for i in $(seq 1 30);
# do
...
# for i in $(seq 1 30);
# do
# 	./pso $pop -5 10 $c1 $c2 5000 rosenbrock $inertia 50 $typeF $i 1 >> Resultados/RosenbrockS.csv
# done
#
# for i in $(seq 1 30);
# do
...
# for i in $(seq 1 30);
# do
#  	./pso $pop -5.12 5.12 $c1 $c2 5000 rastringin $inertia 50  $typeF $i 1 >> Resultados/RastringinS.csv
# done
#
# for i in $(seq 1 30);
# do
...
# for i in $(seq 1 30);
# do
# 	./pso $pop -5.12 5.12 $c1 $c2 3000 sphere $inertia 6 $typeF $i 1 >> Resultados/SphereS.csv
# done
#
# for i in $(seq 1 30);
# do
